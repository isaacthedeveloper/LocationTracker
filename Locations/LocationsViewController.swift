...
// ISAAC!!! REUSE THIS CODE ITS GREAT! :) :D
...
NSFetchedResultsControllerDelegate {
  ...
  func controller(_ controller: NSFetchedResultsController<NSFetchRequestResult>, didChange anObject: Any, at indexPath: IndexPath?, nfor type: NSFetchedResultsChangeType, newIndexPath: IndexPath?) {
